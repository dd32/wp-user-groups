 ...
 * Description:       Unix-style user groups for WordPress. Define groups, attach a role to each, and grant access to users by group membership. Works on single site and multisite.
 * Version:           0.1.0
